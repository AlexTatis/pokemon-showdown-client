	...
	this.MainMenuRoom = this.Room.extend({
		...
		openPM: function (name, dontFocus) {
			...
			if (!$pmWindow.length) {
				...
				buf += '<br><div class="pm-log"><div class="pm-buttonbar"><button class="pm-challenge">Challenge</button><button class="pm-userOptions">...</button></div><div class="inner" role="log"></div></div>';
